...
namespace Magazyn
{
    ...
    public class Forms : Form
    {
        ...
        //Karty Graficzne
        GraphicCard gtx1050TI = new GraphicCard("ASUS CERBERUS GeForce GTX 1050TI O4G", 998, 4, 1480, true);
        ...
        Disk seagateFireCuda = new Disk("Seagate FireCuda", 489, 2000, Enum.GetName(typeof(diskType), diskType.HDD));
        Disk seagateIronWolf = new Disk("Seagate IronWolf", 522, 4000, Enum.GetName(typeof(diskType), diskType.HDD));
